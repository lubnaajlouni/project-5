<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="Project__5_.Admin" %>
        ...
        <div class="app">
            ...
            <aside class="sidebar">
                <p class="welcome">Welcome Admin !</p>
                   ...
                   <div class="menu">
                <a href="Admin.aspx" class="menu-item is-active">Customer</a>
            ...
            <main class="maincontent" style="background-color:#E5E5E5;;">
                <p class="survey">Customer</p>
         
    <form id="form1" runat="server">

<%--        <asp:Button ID="AddCustomer" runat="server" Text="Add User" class="btn btn-success" OnClick="AddCustomer_Click" />--%>
  </form>
                <br />
